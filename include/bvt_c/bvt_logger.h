...
/** Opaque type for BVTLogger object instances */
typedef struct BVTOpaqueLogger* BVTLogger;

/** Destroy a BVTLogger object
 *  @param obj Object pointer
*/
BVTSDK_EXPORT void BVTLogger_Destroy(BVTLogger obj);
 ...
 */
BVTSDK_EXPORT RetVal BVTLogger_Create(BVTLogger* logger);
